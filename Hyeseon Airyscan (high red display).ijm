...
function SaveAsJPEG(path, imagepath) {
	...
	run("RGB Color");
	run("Merge Channels...", "c1=Image-0001 c5=Image-0003 keep");
	run("Combine...", "stack1=Image-0001 stack2=Image-0003");
	run("Combine...", "stack1=Image-0002 stack2=RGB");
	rename("Combined 2");
	run("Combine...", "stack1=[Combined Stacks] stack2=[Combined 2] combine");
	saveAs("jpeg", path+namenoext+"_Airyscan_high.jpg");
	close("*");
}
